 ...
 * Q64.java
 *
 * Created on Nov 1, 2017, 4:33:26 PM
 */
 ...
 * @author Admin
 */
public class Q64 extends javax.swing.JFrame {

    /** Creates new form Q64 */
    public Q64() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Q4)Who was first Indian to win World Amateur Billiards title?");

        buttonGroup1.add(r3);
        r3.setText("Wilson Jones");

        buttonGroup1.add(r4);
        r4.setText("Michael  Ferreira   ");

        buttonGroup1.add(r1);
        r1.setText("Geet Sethi");

        buttonGroup1.add(r2);
        r2.setText("Manoj Kothari");
