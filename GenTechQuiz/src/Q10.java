 ...
 * Q10.java
 *
 * Created on Nov 1, 2017, 10:15:33 PM
 */
...
public class Q10 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buttonGroup1.add(r3);
        r3.setText("To decrease the voltage momentarily");

        buttonGroup1.add(r1);
        r1.setText("To decrease the current");

        buttonGroup1.add(r2);
        r2.setText("To increase the current");

        buttonGroup1.add(r4);
        r4.setText("To increase the voltage momentarily");

        jLabel2.setText("10.) The purpose of choke in tube light is ?");
